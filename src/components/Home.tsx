    ...
    <div className="p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-red-500 text-white rounded-lg shadow p-4">
          ...
          <p className="text-white text-sm">+2.4% from last month</p>
        </div>
        ...
        <div className="bg-red-500 text-white rounded-lg shadow p-4">
          ...
          <p className="text-white text-sm">3 closing soon</p>
        </div>
        ...
        <div className="bg-red-500 text-white rounded-lg shadow p-4">
          ...
          <p className="text-white text-sm">+12 this week</p>
        </div>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#555555] text-white rounded-lg shadow p-4">
          <h3 className="font-medium mb-4">Activity Overview</h3>
          <div className="h-64 flex items-center justify-center">
            <Activity className="text-white" size={100} />
          </div>
        </div>
        ...
        <div className="bg-[#555555] text-white rounded-lg shadow p-4">
          ...
          <div className="h-64 flex items-center justify-center">
            <PieChart className="text-white" size={100} />
          </div>
        </div>
      </div>
    </div>
